...
![Скрин версии Docker](/Nginx%20в%20Docker/img/1.png)
...
![Тут нужен скриншот вывода](/Nginx%20в%20Docker/img/2.png)
...
![Скрин вывода поиска по слову nginx](/Nginx%20в%20Docker/img/3.png)
...
![Тут нужен скриншот](/Nginx%20в%20Docker/img/4.png)
...
![Тут нужен скриншот вывода](/Nginx%20в%20Docker/img/5.png)
...
![Скрин состояния docker images](/Nginx%20в%20Docker/img/6.png)
...
![Скрин образа](/Nginx%20в%20Docker/img/7.png)
...
docker ps -a
```
![Скрин контейнера](/Nginx%20в%20Docker/img/8.png)
...
![Скрин вывода curl](/Nginx%20в%20Docker/img/9.png)

Способ 2 - [открыть http://localhost/ адрес в браузере](http://localhost/)

![Скрин nginx в браузере](/Nginx%20в%20Docker/img/10.png)
...
uname -a
```
![](/Nginx%20в%20Docker/img/13.png)

Получить больше информации об ОС контейнера
```shell
cat /etc/os-release
```
![](/Nginx%20в%20Docker/img/14.png)
...
fastfetch
```
![Вывод команды fastfetch](/Nginx%20в%20Docker/img/15.png)
...
![Скрин вывода htop](/Nginx%20в%20Docker/img/16.png)
...
![Скрин вывода cmatrix](/Nginx%20в%20Docker/img/17.png)
...
hollywood
```
![Скрин вывода hollywood](/Nginx%20в%20Docker/img/18.png)
